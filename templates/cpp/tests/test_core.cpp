...
TEST(CoreTest, AddIntegers) { EXPECT_DOUBLE_EQ(add_numbers(2, 3), 5); }

TEST(CoreTest, AddFloats) { EXPECT_DOUBLE_EQ(add_numbers(2.5, 3.5), 6.0); }
...
INSTANTIATE_TEST_SUITE_P(AddTestSuite, AddParameterizedTest,
